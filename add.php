			...
			if(isset($_POST['add'])){
			 ...
			 $miConsulta = "SELECT * FROM empleados WHERE codigo = '$codigo'"; //crear consulta que seleccione el registro donde el campo codigo sea igual a la variable $codigo
				...
				if(mysqli_num_rows($cek) == 0){
                        $miConsulta = "INSERT INTO empleados(codigo, nombres, lugar_nacimiento, fecha_nacimiento,direccion,telefono,puesto,estado) VALUES('$codigo','$nombres','$lugar_nacimiento','$fecha_nacimiento','$direccion', '$telefono','$puesto','$estado')"; //crear la consulta del INSERT INTO 

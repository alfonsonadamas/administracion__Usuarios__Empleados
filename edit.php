	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
                ...
                $miConsulta = "UPDATE empleados SET nombres = '$nombres', lugar_nacimiento = '$lugar_nacimiento' 
								, fecha_nacimiento = '$fecha_nacimiento' WHERE codigo = '$codigo'"; //Crear el UPDATE para el campo codigo igual a variable $nik

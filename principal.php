...
<body>
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_GET['aksi']) == 'delete'){
                ...
                $miConsulta = ""; //buscar el empleado que tenga en el campo codigo lo que hay en la variable $nik para ser eliminado
			...
			<table class="table table-striped table-hover">
				...
				if($filter){
                    ...
                    $miConsulta = "SELECT * FROM empleados ORDER BY codigo ASC"; //crear una consulta que muestre a todos los empleados de la tabla empleados ordenadas por el campo código
					$sql = mysqli_query($con, $miConsulta);
				}
	...
	<a class = "boton" href="usuarios.php">Usuarios</a>
	<br><br>
